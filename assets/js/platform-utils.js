...
/**
 * Toggles visibility of platform-specific UI elements based on whether the user is on a Mac.
 *
 * Elements with the class `.mac-theme-text` are shown only on Mac platforms, while elements with the class `.default-theme-text` are shown only on non-Mac platforms.
 */
